...
public class Product {
	...
	public Product(Pizzas nameOfPizza, Sizes sizeOfPizza) {
	...
	private double generatePrice(Pizzas name2, Sizes size2) {
		double normalPrice;
	...
	private String generateDescription(Pizzas name2){
		String descrp="";
